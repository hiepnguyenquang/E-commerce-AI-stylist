...
Nhóm cũng xin cảm ơn các thầy cô trong khoa đã cung cấp nền tảng kiến thức về lập trình web, cơ sở dữ liệu, trí tuệ nhân tạo và kỹ nghệ phần mềm. Đây là cơ sở để nhóm có thể triển khai một hệ thống kết hợp nhiều thành phần như giao diện người dùng, hệ thống nghiệp vụ thương mại điện tử, hàng đợi tác vụ, cơ sở dữ liệu vector và dịch vụ AI.

\medskip

Do thời gian thực hiện có hạn, hệ thống vẫn còn một số giới hạn của bản triển khai tối thiểu. Nhóm mong nhận được góp ý để tiếp tục cải thiện sản phẩm trong các giai đoạn sau.
