...
Ràng buộc QUAN TRỌNG: Mỗi Option PHẢI là một BỘ ĐỒ HOÀN CHỈNH. Tức là nó phải bao gồm ít nhất một Áo (tops) và một Quần/Váy (bottoms), HOẶC một chiếc Váy liền (dresses). Không bao giờ được gợi ý chỉ một chiếc áo hoặc chỉ một chiếc quần. Bạn có thể thêm giày (shoes) hoặc phụ kiện (accessories) nếu có trong danh sách.
