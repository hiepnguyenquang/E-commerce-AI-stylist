...
\begin{tikzpicture}
    ...
    \node[diagram small box, ellipse, minimum width=4.0cm] (profile) at (5,1) {Thiết lập hồ sơ AI};
    \node[diagram small box, ellipse, minimum width=4.0cm] (wardrobe) at (5,-1) {Quản lý tủ đồ};
    ...
    \node[diagram small box, ellipse, minimum width=4.0cm] (replace) at (10,-3) {Đổi sản phẩm tương tự};
    \node[diagram small box, ellipse, minimum width=4.0cm] (checkout) at (15,3) {Thanh toán mô phỏng};
...
\caption{Sơ đồ trường hợp sử dụng tổng quát của hệ thống}
\label{fig:use-case}
\end{figure}
